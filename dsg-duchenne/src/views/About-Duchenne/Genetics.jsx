...
class Genetics extends Component{
    render(){
        return(
              <React.Fragment>
                <Navbar/>
                  <div id="genetics" className="container">
                    ...
                    <ul>
                      <li><span className="lista">44 autosomas (pares 1-22)</span></li>  
                      <li><span className="lista">2 cromosomas sexuales (par 23)</span></li>
                    </ul>
                    ...
                    <ul>
                      <li><span className="lista"> Cada vez que una mujer portadora tiene un hijo , hay un 50% de posibilidades (o 1 de 2) de que se vea afectado con Duchenne.</span></li>
                      <li><span className="lista"> Cada vez que una mujer portadora tiene una hija , hay un 50% de posibilidades (o 1 de 2) de que sea portadora o portadora manifestante.</span></li>
                    </ul>

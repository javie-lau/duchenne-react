    ...
    render(){
        return(
         <React.Fragment>
             <Navbar/>
             <div id="situation">
               <h1 id="title-situation">Siatuación País</h1>
               ...
               <p className="situation-p">Según un informe publicado por el MINSAL, en Chile los costos asociados a la Distrofia Muscular de Duchenne son muy altos y no todos los pacientes pueden acceder a ellos.</p>

        ...
        return(
         <React.Fragment>
             ...
             <div id="situation">
               ...
               <p>Según un informe publicado por el MINSAL, en Chile los costos asociados a la Distrofia Muscular de Duchenne son muy altos y no todos los pacientes pueden acceder a ellos.</p>
               <p>Uno de los que llama la atención, se encuentra el examen genético, para mujeres, que ayuda a detectar el gen portador de la enfermedad y por lo tanto frenarla, que bordea los $150.000.-</p>

               ...
               <div id="mision">
                  <div className="row">
                     <div className="body offset-md-1 col-md-8">
                        ...
                        <h4> 1. Detección precoz:</h4>
                        <p> Duchenne es una enfermedad genética, que en un 60% de los
                        ...
                        <h4>2. Superación de la enfermedad:</h4>
                        <p> Duchenne es una de las enfermedades genéticas raras
                        ...
                        <h4>3. Ganar vida:</h4>
                        <p>Nuestro proyecto busca que mediante el desarrollo y la investigación
                        ...
                        <p> Buscamos alentar la generación de tratamientos basados en la ciencia,
                        con evidencia segura y comprobada.
                        </p>
                        <h4>Accesibilidad:</h4>
                        <p> Queremos fomentar el desarrollo de tratamientos que sean accesibles
                        ...
                        <h4>Transparencia: </h4>
                        <p> Nuestro objetivo final es mejorar la vida de los niños que sufren Distrofia
